...
public class Merchant {
	...
	public void getPotionSmallImg() {
		String path = "/FOTOS ELDEN ARK/POTIONS/SMALL/";
		String toReturn;
		switch (typeObject1) {
			case 0:
				toReturn = path.concat("SMALL_POTION_HEAL");
				setSmallObjImage(toReturn);
				break;
			case 2:
				toReturn = path.concat("SMALL_POTION_MANA");
				setSmallObjImage(toReturn);
				break;
		}
	}
	...
	public void getPotionLargeImg() {
		String path = "/FOTOS ELDEN ARK/POTIONS/LARGE/";
		String toReturn;
		switch (typeObject2) {
			case 0:
				toReturn = path.concat("LARGE_POTION_HEAL");
				setLargeObjImage(toReturn);
				break;
			case 2:
				toReturn = path.concat("LARGE_POTION_MANA");
				setLargeObjImage(toReturn);
				break;
		}
	}
